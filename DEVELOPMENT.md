...
- Latest released version is `1.2.2` on `main`. For releases, update `StockAlertInfo.cs`, `CHANGELOG.md`, `dist/thunderstore/manifest.json`, rebuild, refresh `dist/thunderstore/StockAlert.dll`, `README.md`, and `CHANGELOG.md`, then create `dist/StockAlert-Thunderstore-<version>.zip`.
